...
export default function CourseDetail() {
  ...
  const courseData = {
    ...
    category: "Full Stack",
    price: "5,999",
    instructor: "Sara Aziz",
    level: "Intermediate",
    duration: "14 Lectures",
    description: "Build responsive websites with modern JavaScript, React, and deployment best practices.",
    curriculum: [
      { id: 1, title: "HTML & CSS Modern Layouts", duration: "20 min", isFree: true, sub: "Create polished pages using modern web standards." },
      { id: 2, title: "JavaScript + DOM Interactions", duration: "32 min", isFree: false, sub: "Build dynamic user experiences with JavaScript." },
      { id: 3, title: "React Components & Hooks", duration: "40 min", isFree: false, sub: "Learn React fundamentals for building scalable UI." },
      { id: 4, title: "Responsive Design & Accessibility", duration: "28 min", isFree: false, sub: "Make sites that work on every device and audience." },
      { id: 5, title: "Deploying Your Site", duration: "24 min", isFree: false, sub: "Launch your project live with modern hosting workflows." }
    ]
  };
          ...
          <div className="mt-20 p-10 bg-gray-50 rounded-[3rem] flex flex-col md:flex-row gap-10 items-center border border-gray-100">
            ...
            <div>
              ...
              <p className="text-gray-500 font-medium leading-relaxed italic">
                "Build modern web applications that look professional and load quickly on every device." 
              </p>
            </div>
          </div>
        </div>
