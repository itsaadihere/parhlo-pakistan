...
export default function CourseDetail() {
  ...
  const courseData = {
    ...
    description: "Get started with data science concepts, visualization, and using Python for insights and decision making.",
    curriculum: [
      { id: 1, title: "Data Basics & Python Setup", duration: "20 min", isFree: true, sub: "Prepare your tools and learn core data programming concepts." },
      { id: 2, title: "Data Cleaning Techniques", duration: "32 min", isFree: false, sub: "Clean, transform, and prepare data like a pro." },
      { id: 3, title: "Visualization with Charts", duration: "28 min", isFree: false, sub: "Turn raw data into easy-to-read visual reports." },
      { id: 4, title: "Statistics for Business", duration: "26 min", isFree: false, sub: "Understand trends, averages, and predictions." },
      { id: 5, title: "Mini Project: Data Story", duration: "22 min", isFree: false, sub: "Build a story around your data findings." }
    ]
  };
          ...
          <div className="mt-20 p-10 bg-gray-50 rounded-[3rem] flex flex-col md:flex-row gap-10 items-center border border-gray-100">
            ...
            <div>
              ...
              <p className="text-gray-500 font-medium leading-relaxed italic">
                "Learn how to make data-driven decisions from day one with simple tools and strong storytelling." 
              </p>
            </div>
          </div>
        </div>
