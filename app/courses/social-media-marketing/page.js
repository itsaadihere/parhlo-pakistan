...
export default function CourseDetail() {
  ...
  const courseData = {
    ...
    price: "2,200",
    instructor: "Aliya Fatima",
    level: "Beginner",
    duration: "9 Lectures",
    description: "Learn how to create campaigns, grow engagement, and convert followers into paying customers.",
    curriculum: [
      { id: 1, title: "Marketing Basics & Platform Strategy", duration: "18 min", isFree: true, sub: "Build the right strategy for Facebook, Instagram, and TikTok." },
      { id: 2, title: "Content Planning & Copywriting", duration: "30 min", isFree: false, sub: "Create content that engages and converts your audience." },
      { id: 3, title: "Ad Creation & Budgeting", duration: "34 min", isFree: false, sub: "Run paid ads without wasting your budget." },
      { id: 4, title: "Analytics & Growth Tracking", duration: "26 min", isFree: false, sub: "Measure results and optimize campaigns for growth." },
      { id: 5, title: "Freelance Social Media Projects", duration: "22 min", isFree: false, sub: "Work with clients, manage campaigns, and deliver results." }
    ]
  };
          ...
          <div className="mt-20 p-10 bg-gray-50 rounded-[3rem] flex flex-col md:flex-row gap-10 items-center border border-gray-100">
            ...
            <div>
              ...
              <p className="text-gray-500 font-medium leading-relaxed italic">
                "A practical course to grow social media presence and convert followers into clients." 
              </p>
            </div>
          </div>
        </div>
