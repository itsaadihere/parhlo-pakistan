...
export default function CourseDetail() {
  ...
  const courseData = {
    ...
    description: "Start coding in Python with real-world projects, from automation to data analysis and web scripting.",
    curriculum: [
      { id: 1, title: "Python Setup & Basic Syntax", duration: "16 min", isFree: true, sub: "Install Python, write your first scripts, and understand variables." },
      { id: 2, title: "Data Types & Control Flow", duration: "30 min", isFree: false, sub: "Build logic with loops, conditions, lists, and dictionaries." },
      { id: 3, title: "Functions & Modules", duration: "26 min", isFree: false, sub: "Create reusable code and organize projects with modules." },
      { id: 4, title: "File Handling & Automation", duration: "38 min", isFree: false, sub: "Automate tasks with file operations and scheduling." },
      { id: 5, title: "Intro to Data Analysis", duration: "25 min", isFree: false, sub: "Use Python for charts, tables, and insights." }
    ]
  };
          ...
          <div className="mt-20 p-10 bg-gray-50 rounded-[3rem] flex flex-col md:flex-row gap-10 items-center border border-gray-100">
            ...
            <div>
              ...
              <p className="text-gray-500 font-medium leading-relaxed italic">
                "Python fundamentals designed for fast learners who want to build practical tools and real automation." 
              </p>
            </div>
          </div>
        </div>
