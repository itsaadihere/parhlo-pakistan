...
export default function CourseDetail() {
  ...
  const courseData = {
    title: "FSc Math Board Exam Prep",
    category: "School & College",
    price: "1,999",
    instructor: "Sir Usman Tariq",
    level: "Intermediate",
    duration: "5 Lectures",
    description: "Federal & Punjab board first-year and second-year math. Concept-based teaching with hundreds of solved past-paper questions.",
    curriculum: [
      { id: 1, title: "Welcome & Course Roadmap", duration: "8 min", isFree: true, sub: "What you'll learn, how to study, and how to ask questions." },
      { id: 2, title: "Foundations: Setup & First Steps", duration: "22 min", isFree: false, sub: "Get your tools ready and complete your first practice task." },
      { id: 3, title: "Algebra Deep Dive", duration: "45 min", isFree: false, sub: "Mastering complex equations and sets." },
      { id: 4, title: "Trigonometry Essentials", duration: "40 min", isFree: false, sub: "Understanding identities and circular measure." },
      { id: 5, title: "Final Board Exam Strategy", duration: "15 min", isFree: false, sub: "How to attempt the paper to score 100%." }
    ]
  };
      ...
      <nav className="border-b border-gray-100 p-4 bg-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4">
          ...
          <div className="flex gap-4">
            <button className="p-2 text-gray-400 hover:text-gray-900"><Share2 size={20}/></button>
          </div>
        </div>
      </nav>
