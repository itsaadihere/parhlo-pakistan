...
export default function CourseDetail() {
  ...
  const courseData = {
    ...
    level: "Beginner",
    duration: "8 Lectures",
    description: "Learn Excel workflows and accounting shortcuts that help you manage books, reports, and client work quickly.",
    curriculum: [
      { id: 1, title: "Spreadsheet Basics & Formatting", duration: "20 min", isFree: true, sub: "Learn clean formatting, formulas, and quick accounting layouts." },
      { id: 2, title: "Accounting Functions & Pivot Tables", duration: "36 min", isFree: false, sub: "Powerful techniques for financial reporting and business summaries." },
      { id: 3, title: "Budget Tracking & Cash Flow", duration: "28 min", isFree: false, sub: "Create reusable templates for cash flow and expense tracking." },
      { id: 4, title: "Advanced Excel for Invoicing", duration: "24 min", isFree: false, sub: "Build automated invoices, transaction logs, and ledger dashboards." },
      { id: 5, title: "Presentation & Client Reports", duration: "18 min", isFree: false, sub: "Turn raw data into polished reports for managers and clients." }
    ]
  };
          ...
          <div className="mt-20 p-10 bg-gray-50 rounded-[3rem] flex flex-col md:flex-row gap-10 items-center border border-gray-100">
            ...
            <div>
              ...
              <p className="text-gray-500 font-medium leading-relaxed italic">
                "Practical Excel techniques for accountants, bookkeepers, and financial freelancers who want fast results."
              </p>
            </div>
          </div>
        </div>
